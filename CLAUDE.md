...
## Policies
- Assets: CC0 and CC-BY (with credit) only, ≤ 80 MB committed in `public/assets/`; no real logos, sponsor names or trademarks in generated textures (`textures-lint.mjs` with `scripts/trademark-*.json`).
