...
ブラウザの自動再生制限のため音はその操作後に作られ、スタートシグナルの 1 灯ごとのトーンと消灯音もそこから鳴ります。
...
スタートシグナルには 1 灯ごとのトーンと消灯音が付き、グリッドではアイドル中のエンジンが鳴ってランプに合わせて回転が上がります。
...
app/
  ...
  three/
    ...
    audio.ts                   # WebAudio 合成のエンジン音（次数スタック、ターボ、MGU-K、シフト／オーバーラン、ドップラー）、風切り音、群衆、カウントダウン音、オフラインプローブ
...
- ギアは 8 速（12,000 rpm リミッター、11,800 でシフトアップ、7,600 未満でシフトダウン、減速時はエンジンブレーキ側へ早めにシフトダウン）。
  1 速はローンチ専用で、最高速 331 km/h は 8 速 ≈ 11,900 rpm、ヘアピン（約 70 km/h）は 2 速 ≈ 8,200 rpm、130R は 8 速になります。
