...
const ALLOWANCES = [
  ...
  { guard: 'G3', key: "ground:gravelArea", bound: 8.73, why: `${WHY.fieldCells} ${WHY.cutWalls}`, until: 'P7' }, // I6-a: measured 8.31 on both tiers (--suggest), was 7.5 — the corridors' gravel rings chord the wall foot
  ...
  { guard: 'G3', key: "ground:asphaltArea", bound: 4.4, why: `${WHY.fieldCells} ${WHY.infieldRings} ${WHY.cutWalls}`, until: 'P7' }, // I6-a: measured 4.19 on both tiers (--suggest), was 4.07 (I5-a 3.87, before that 0) — the corridors' road rings at the wall feet and the daylight ends
  ...
  { guard: 'G4', key: "ground:asphaltArea.steep", bound: 3128, why: `${WHY.fieldCells} ${WHY.infieldRings} ${WHY.cutWalls}`, until: 'P7' }, // I6-a: measured 2979 on both tiers (--suggest), was 1994 (I5-a 1899, before that 70) — the corridors' road rings within a metre of the walls
  ...
  { guard: 'G4', key: "ground:gravelArea.steep", bound: 3898, why: `${WHY.fieldCells} ${WHY.demCurvature} ${WHY.infieldRings} ${WHY.cutWalls}`, until: 'P7' }, // I6-a: measured 3712 on both tiers (--suggest), was 216 (I5-c 205, I5-a 153, before that 65) — the corridors' gravel rings are the 0.5–2 m band along every wall
  { guard: 'G4', key: "ground:gravelBand.steep", bound: 63, why: `${WHY.fieldCells} ${WHY.infieldRings} ${WHY.cutWalls}`, until: 'P7' }, // I6-a: measured 60 on both tiers (--suggest), was 56 (I5-a 53, before that 50) — a run-off band within a metre of a corridor wall
  ...
  { guard: 'G4', key: "ground:lane.steep", bound: 73, why: `${WHY.fieldCells} ${WHY.infieldRings} ${WHY.cutWalls}`, until: 'P7' }, // I6-a: measured 69 on both tiers (--suggest), was 54 (I5-a 51, before that 50) — a lane within a metre of a corridor wall
