...
// posts' digital flags, the pit-exit signal, the garage-interior wash, the ops monitors and
// the terrace downlights (I phase). They stay below the threshold on the high tier,
